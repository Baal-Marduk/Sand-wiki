  ...
  return (
    <form action="/items" method="get" className="card bg-base-200 mb-6">
      <div className="card-body grid gap-3 sm:grid-cols-6 items-end">
        ...
        <div>
          <label htmlFor="workbench" className="block text-sm font-medium mb-1">Workbench level</label>
        ...
        <div>
          <label htmlFor="resource" className="block text-sm font-medium mb-1">Uses resource</label>
