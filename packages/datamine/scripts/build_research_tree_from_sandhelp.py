"""
Build sek-out/research_tree.json from a sand-help.com/tech DOM extract.
...
OUTPUT: sek-out/research_tree.json
...
DATAMINE = os.path.abspath(os.path.join(HERE, ".."))
RAW = os.path.join(DATAMINE, "sandhelp", "sandhelp_tree_exact.json")
THUMBS = os.path.join(DATAMINE, "sek-out", "part_thumbs_v2.json")
OUT = os.path.join(DATAMINE, "sek-out", "research_tree.json")
