...
Output: ../../apps/wiki/public/parts2/<part_id>.png + sek-out/part_thumbs_v2.json
...
IDX = json.load(open('sek-out/mesh_index_v2.json', encoding='utf-8'))
PARTS = json.load(open('sek-out/parts_v2.json', encoding='utf-8'))['parts']
SRC = '../../apps/wiki/public/meshes2'
OUT = '../../apps/wiki/public/parts2'
...
json.dump(thumbs, open('sek-out/part_thumbs_v2.json', 'w'), indent=0)
