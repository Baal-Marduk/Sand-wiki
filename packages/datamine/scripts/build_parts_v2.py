...
old = {}
try:
    old = {p['id']: p for p in json.load(open('sek-out/parts.json', encoding='utf-8'))}
...
LOC_COMP = {}
try:
    LOC_COMP = json.load(open('sek-out/localization.json', encoding='utf-8'))['compartments']
except FileNotFoundError:
...
json.dump(out, open('sek-out/parts_v2.json', 'w', encoding='utf-8'),
