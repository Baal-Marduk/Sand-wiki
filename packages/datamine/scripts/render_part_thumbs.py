...
Output: ../../apps/wiki/public/parts/<part_id>.png + sek-out/part_thumbs.json
"""
...
OUT = '../../apps/wiki/public/parts'
os.makedirs(OUT, exist_ok=True)

# ---- 1. part -> view name from EPBs ----
parts = json.load(open('sek-out/parts.json', encoding='utf-8'))
...
json.dump(thumbs, open('sek-out/part_thumbs.json', 'w'), indent=0)
