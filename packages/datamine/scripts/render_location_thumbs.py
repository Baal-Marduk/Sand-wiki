...
Output: ../../apps/wiki/public/locart/<root>.png + sek-out/location_art.json
...
extra_locs = json.load(open('sek-out/extra_locations.json', encoding='utf-8'))
...
json.dump(art, open('sek-out/location_art.json', 'w', encoding='utf-8'), indent=1)
