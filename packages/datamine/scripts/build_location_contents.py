...
Output: sek-out/location_contents.json keyed by lootset location id where matchable.
"""
import json, re

raw = json.load(open('extracted/json/location_contents.json', encoding='utf-8'))
site_locs = json.load(open('sek-out/locations.json', encoding='utf-8'))
...
json.dump(out, open('sek-out/location_contents.json', 'w', encoding='utf-8'), indent=1)
...
json.dump(extras, open('sek-out/extra_locations.json', 'w', encoding='utf-8'), indent=1)
